  ...
  return (
    <div className="absolute bg-gray-900/80 w-full min-h-screen" onClick={handleModalClick}>
      <div className="absolute inset-0 flex items-center justify-center">
        <div ref={modalRef} className="bg-gray-100 shadow-lg w-4/5 md:w-1/2 max-w-2xl p-3 rounded">
          ...
          <div className="flex flex-wrap gap-1 mb-2">
            ...
            <InputMask mask="(99) 99999-9999" value={ticket?.customer?.phone} readOnly />
          </div>
